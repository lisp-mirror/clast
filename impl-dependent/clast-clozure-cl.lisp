...
(defmethod print-object ((pe parsing-environment) stream)
  (print-unreadable-object (pe stream :identity t)
    (write-string "CLAST CCL Parsing Environment" stream)))


(defmethod is-environment ((e parsing-environment)) t)
(defmethod is-environment ((e ccl::lexical-environment)) t)
...
(declaim (inline get-implementation-env)
         (ftype (function ((or null
                          ...
                          (or null ccl::lexical-environment)
...
(defun variable-information (variable
  ...
  (env-item-info #'ccl:variable-information variable env))
...
(defun function-information (f
  ...
  (env-item-info #'ccl:function-information f env))
...
(defun declaration-information (decl-name
  ...
  (env-item-info #'ccl:declaration-information decl-name env)
  )
...
;;; Notes:
;;;
;;; 2024-06-27 MA: Lots of duplicated code here from the other
...
This is a destructive function."
  ...
  ;; Being paranoid.
  (check-type global-env (or null ccl::lexical-environment))
